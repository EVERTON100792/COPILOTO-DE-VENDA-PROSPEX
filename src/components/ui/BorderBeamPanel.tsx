...
/* -------------------------------------------------------------------------- */
/* Border Beam Panel (Adapted for Vanilla React/CSS without Tailwind)       */
/* -------------------------------------------------------------------------- */

const MOTIQ_TOKENS = `:root{
  --motiq-accent: #f87171;
  --motiq-accent-text: #ef4444;
  --motiq-bg: #030305;
  --motiq-border: rgba(255, 255, 255, 0.08);
  --motiq-border-strong: rgba(255, 255, 255, 0.15);
  --motiq-fg: #ffffff;
  --motiq-fg-secondary: #a1a1aa;
  --motiq-muted: #52525b;
  --motiq-secondary-accent: #818cf8;
  --motiq-signature: #10b981;
  --motiq-surface: rgba(20, 20, 25, 0.4);
  --motiq-surface-2: rgba(30, 30, 40, 0.3);
}`;
...
.${cls} .mk-beam-glow { filter: blur(14px); opacity: 0.45; z-index: -1; }
